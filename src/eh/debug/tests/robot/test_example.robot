...
#
#  $ bin/test -s eh.debug -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src eh.debug.testing.EH_DEBUG_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/eh/debug/tests/robot/test_example.robot
#
